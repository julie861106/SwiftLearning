...
class SearchAccessoriesTableViewController: UITableViewController, NSFetchedResultsControllerDelegate, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    var products:[Product] = [
        ...
        Product(name:"Silver Super Lustrous Butterfly Bracelet Homemade Style", store:"accessories", type:"1983049581", price:"7.98", image:"http://ecx.images-amazon.com/images/I/41BdF%2B4Q47L._SY300_.jpg", isLiked: false, description: "Butterfly Bracelet", cart: false),
        Product(name:"Vintage Durable Canvas Briefcase School Crossbody Messenger Book Bag", store:"accessories", type:"2258798612", price:"29.99", image:"http://ecx.images-amazon.com/images/I/51Dh4gWIeaL._SY300_.jpg", isLiked: false, description: "Please refer to HD photo for best product details.", cart: false),
        Product(name:"Blessed by Pope Benedetto XVI Wood Religious Bracelet", store:"accessories", type:"3293015344", price:"9.99", image:"http://ecx.images-amazon.com/images/I/41n8msKKcUL._SX300_.jpg", isLiked: false, description: "This religious item was blessed by Pope Benedict XVI  in Rome, Italy... Included is little card with the blessing and a beautiful organza bag to keep your religious item.", cart: false),
