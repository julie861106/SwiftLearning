...
class SearchAccessoriesTableViewController: UITableViewController, NSFetchedResultsControllerDelegate, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    var products:[Product] = [
        ...
        Product(name:"Silver Super Lustrous Butterfly Bracelet Homemade Style", store:"accessories", type:"1983049581", price:"7.98", image:"http://ecx.images-amazon.com/images/I/41BdF%2B4Q47L._SY300_.jpg", isLiked: false, description: "Brand new and high quality", cart: false),
